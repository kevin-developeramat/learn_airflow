...
def second_task():
    ...
    # raise ValueError('This will turns the python task in failed state')c
...
with DAG(dag_id='depends_task', schedule_interval="0 0 * * *", default_args=default_args) as dag:
    ...
    # Task 3
    python_task_3 = PythonOperator(task_id='python_task_3', python_callable=third_task, wait_for_downstream=True)
